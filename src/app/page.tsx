...
const plans = [
  {
    ...
    price: 'Grátis',
    period: '',
    desc: 'Para testes e pequenas oficinas',
    plan: null,
    features: [
  ...
  },
  {
    ...
    price: '19€',
    period: '/mês',
    desc: 'Para pequenas equipas industriais',
    plan: 'starter',
    features: [
      'Até 5 técnicos + 2 gestores',
      '100 intervenções/mês',
      'Gestão de Stocks básica',
  ...
  },
  {
    ...
    price: '49€',
    period: '/mês',
    desc: 'Para fábricas e PMEs em crescimento',
    plan: 'pro',
    features: [
      'Até 15 técnicos + 3 gestores',
      '500 intervenções/mês',
      'Planos de Manutenção Preventiva',
      'KPIs de Fiabilidade (MTTR/MTBF)',
      'Relatórios PDF & Excel Ilimitados',
      'Peças & Itens de Segurança',
    ],
  ...
  },
  {
    ...
    plan: 'business',
    features: [
      'Técnicos & Gestores Ilimitados',
      'Intervenções Ilimitadas',
      'Consultor IA (com RAG & ficheiros)',
