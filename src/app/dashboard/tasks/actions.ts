...
export async function updateTaskAction(
  ...
  // Decisão do Rui: a edição da OT (formulário completo) é exclusiva do gestor. Um técnico
  // altera o estado/fecha a OT através de updateTaskStatusAction, não desta ação.
