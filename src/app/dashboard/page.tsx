...
import { listTasks, listUsers, listAssets, listInterventions, getTasksForYearStats, getPMComplianceForYear } from '@/lib/firebase/data'
...
export default async function DashboardPage() {
  ...
  const [tasks, openTasks, yearTasks, pmCompliance, usersList, assets, interventions, yearlyTasksForAssets] = await Promise.all([
    ...
    getPMComplianceForYear(profile.companyId, currentYear),
  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in-up">
      ...
      <DashboardKpiCards openTasks={openTasks} initialYear={currentYear} initialYearTasks={yearTasks} initialPMCompliance={pmCompliance} />
