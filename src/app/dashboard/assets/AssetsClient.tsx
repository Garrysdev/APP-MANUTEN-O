...
export default function AssetsClient({ assets, plan }: { assets: Asset[], plan: PlanName }) {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {printQRAsset && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 print:p-0 print:bg-white bg-black/40 dark:bg-black/60 backdrop-blur-sm print:backdrop-blur-none">
